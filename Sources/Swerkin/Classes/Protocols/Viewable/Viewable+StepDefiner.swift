...
extension Steps: Viewable {
    ...
    public func element(withLabel label: String) -> UIView? {
        return self.viewTester.view(withLabel: label)!
    }

    public func allElements(withIdentifier identifier: String) -> [UIView] {
    ...
    public func allValues(for element: UIView) -> [String] {
    ...
    public func allNestedSubviews(_ parent: UIView) -> [UIView] {
